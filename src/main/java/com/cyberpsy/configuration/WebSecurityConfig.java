...
public class WebSecurityConfig {
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        authProvider.setUserDetailsService(userDetailsService); // Link your CustomUserDetailsService
        authProvider.setPasswordEncoder(passwordEncoder()); // Ensure password encoding
        return authProvider;
    }
    @Bean
