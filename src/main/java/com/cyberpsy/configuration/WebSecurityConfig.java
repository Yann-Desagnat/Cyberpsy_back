    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorizeRequests ->
                    authorizeRequests
                        .requestMatchers("/api/auth/**","/auth/**","/api/qcm/submit/**", "/api/test/all","/api/qcm/niveau/**","/api/qcm/historique/**").permitAll() // Permet d'accéder à ces requêtes sans authentification
